...
from guoyang.settings import EMAIL_FROM
...
def send_register_eamil(email, send_type="register"):
    ...
    if send_type == "register":
        ...
        # email_body = "<a href='http://127.0.0.1:8000/active/{0}'>请点击激活你的账号</a> ".format(code)
    ...
    if send_type == "forget":
        ...
        # email_body = "<a href='http://127.0.0.1:8000/active/{0}'>点击重新设置密码</a> ".format(code)
